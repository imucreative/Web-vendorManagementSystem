            ...
            <div class="ibox-content">
                ...
                ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="provinsi" class="form-control" placeholder="* Provinsi" value="<?php echo $row->provinsi;?>" readonly required/>
                        </div>
                        <label class="col-sm-1 control-label">Kota</label>
                        <div class="col-sm-5">
                            <input type="text" name="kota" class="form-control" placeholder="* Kota" value="<?php echo $row->kota;?>" readonly required/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-11">
                            <input type="text" name="kelurahan" class="form-control" placeholder="* Kelurahan" value="<?php echo $row->kelurahan;?>" readonly required/>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
